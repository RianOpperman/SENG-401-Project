...
const guid_js_1 = __importDefault(require("./utils/guid.js"));
const index_js_1 = __importDefault(require("./errors/index.js"));
const live_js_1 = __importDefault(require("./classes/live.js"));
const socket_js_1 = __importDefault(require("./classes/socket.js"));
const pinger_js_1 = __importDefault(require("./classes/pinger.js"));
const emitter_js_1 = __importDefault(require("./classes/emitter.js"));
let singleton;
class Surreal extends emitter_js_1.default {
    // ------------------------------
    // Methods
    // ------------------------------
    /**
    ...
    static get AuthenticationError() {
        return index_js_1.default.AuthenticationError;
    }
    static get PermissionError() {
        return index_js_1.default.PermissionError;
    }
    static get RecordError() {
        return index_js_1.default.RecordError;
    }
    static get Live() {
        return live_js_1.default;
    }
    // ------------------------------
    // Accessors
    // ------------------------------
    ...
    connect(url) {
        ...
        __classPrivateFieldSet(this, _Surreal_ws, new socket_js_1.default(url), "f");
        // Setup the interval pinger so that the
        // connection is kept alive through
        // loadbalancers and proxies.
        __classPrivateFieldSet(this, _Surreal_pinger, new pinger_js_1.default(30000), "f");
    ...
    // --------------------------------------------------
    sync(query, vars) {
        return new live_js_1.default(this, query, vars);
    }
    /**
